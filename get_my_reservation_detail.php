...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $stmt->execute([$id_reservasi, $user_id]);
        ...
        if ($reservation) {
            ...
            <div class="reservation-details">
                <div class="detail-section mb-4">
                    <div class="detail-item">
                        <strong>Reservation ID:</strong> <?php echo $reservation['id_reservasi']; ?>
                    </div>
                </div>
                ...
                <div class="section-divider"></div>
                <div class="detail-section mb-4">
                    <h6 class="detail-label mb-3">ORDERED MENU</h6>
                ...
                <div class="detail-section mb-4">
                    ...
                    <div class="detail-item mt-3">
                        ...
                        <?php echo !empty($reservation['catatan']) ? nl2br(htmlspecialchars($reservation['catatan'])) : '<span class="text-white">No notes provided</span>'; ?>
                    </div>
                </div>
                <div class="section-divider"></div>
            ...
            echo '<div class="alert alert-danger">Reservation not found or you do not have permission to view this reservation.</div>';
        }
    } catch (Exception $e) {
